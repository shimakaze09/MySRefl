...
void test_template() {
  ...
  constexpr auto valueAttrs =
      TypeInfo<Data<float>>::fields.Get<valueIdx>().attrs;
...
void test_function() {
  ...
  constexpr auto f0 = TypeInfo<FuncList>::fields
                          .Get<TypeInfo<FuncList>::fields.Find("Func0")>();
  cout << f0.name << endl;
  ...
  constexpr auto f1 = TypeInfo<FuncList>::fields
                          .Get<TypeInfo<FuncList>::fields.Find("Func1")>();
  cout << f1.name << endl;
