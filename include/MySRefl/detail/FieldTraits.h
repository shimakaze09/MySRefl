...
struct FieldTraits<T Object::*> : FieldTraitsBase<Object, T, false> {};

// static member pointer
template <typename T>
struct FieldTraits<T*> : FieldTraitsBase<void, T, true> {};

// enum / static constexpr
template <typename T>
struct FieldTraits : FieldTraitsBase<void, T, true> {};
}  // namespace My::MySRefl::detail
