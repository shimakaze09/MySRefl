...
static constexpr char initializer[] = "_MySRefl_initializer";
static constexpr char default_functions[] = "_MySRefl_default_functions";
static constexpr char constructor[] = "_MySRefl_constructor";
static constexpr char destructor[] = "_MySRefl_destructor";
